<template>
  <div class="min-h-screen bg-gray-100 p-8">
    <div class="max-w-7xl mx-auto">
      <h1 class="text-4xl font-bold mb-8 text-center">🚀 Offres d'emploi - Version Fonctionnelle</h1>
      ...
      <div v-else-if="jobs.length > 0">
        <p class="text-gray-600 mb-6 text-lg">{{ jobs.length }} emplois trouvés (Page {{ pagination?.current_page || 1 }})</p>
        ...
        <!-- 🎯 PAGINATION - LA PARTIE IMPORTANTE ! -->
...
// PAS DE LAYOUT - évite tous les problèmes de redirection
